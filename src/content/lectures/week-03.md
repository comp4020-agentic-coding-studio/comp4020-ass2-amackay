...
Far more verifiers exist than gate set.mm: the home page says "over a dozen", the [Other Topics](https://us.metamath.org/other.html) list runs from Haskell and Lua to Julia, Zig and Lean, and [Wikipedia](https://en.wikipedia.org/wiki/Metamath) says at least 19. Wednesday's lab is the first that counts toward the lab-proof mark; when mmj2 accepts your proof, it has run the stack above.
